...
export class AccountsApi {
     ...
     */
    public async getAccountByAddress (address: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Account;  }> {
        const localVarPath = this.basePath + '/v2/accounts/{address}'
        ...
        if (address === null || address === undefined) {
            throw new Error('Required parameter address was null or undefined when calling getAccountByAddress.');
        }
