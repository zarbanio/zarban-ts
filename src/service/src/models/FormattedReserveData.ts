 ...
 */
export function instanceOfFormattedReserveData(value: object): value is FormattedReserveData {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('underlyingAsset' in value) || value['underlyingAsset'] === undefined) return false;
    if (!('zTokenAddress' in value) || value['zTokenAddress'] === undefined) return false;
    if (!('variableDebtTokenAddress' in value) || value['variableDebtTokenAddress'] === undefined) return false;
    if (!('borrowingEnabled' in value) || value['borrowingEnabled'] === undefined) return false;
    if (!('isActive' in value) || value['isActive'] === undefined) return false;
    if (!('isFrozen' in value) || value['isFrozen'] === undefined) return false;
    if (!('usageAsCollateralEnabled' in value) || value['usageAsCollateralEnabled'] === undefined) return false;
    if (!('reserveFactor' in value) || value['reserveFactor'] === undefined) return false;
    if (!('baseLTVasCollateral' in value) || value['baseLTVasCollateral'] === undefined) return false;
    if (!('reserveLiquidationThreshold' in value) || value['reserveLiquidationThreshold'] === undefined) return false;
    if (!('reserveLiquidationBonus' in value) || value['reserveLiquidationBonus'] === undefined) return false;
    ...
    if (!('supplyAPR' in value) || value['supplyAPR'] === undefined) return false;
    if (!('variableBorrowAPY' in value) || value['variableBorrowAPY'] === undefined) return false;
    if (!('variableBorrowAPR' in value) || value['variableBorrowAPR'] === undefined) return false;
    if (!('price' in value) || value['price'] === undefined) return false;
    return true;
}

export function FormattedReserveDataFromJSON(json: any): FormattedReserveData {
    return FormattedReserveDataFromJSONTyped(json, false);
}

export function FormattedReserveDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): FormattedReserveData {
    if (json == null) {
        return json;
    }
    return {
...
export function FormattedReserveDataToJSON(json: any): FormattedReserveData {
    return FormattedReserveDataToJSONTyped(json, false);
}

export function FormattedReserveDataToJSONTyped(value?: FormattedReserveData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
