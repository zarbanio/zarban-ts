...
export class TransactionsApi {
     ...
     * @param limit Limit the number of transactions returned (default is 100)
     */
    public async getUserTransactions (cursor?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionResponse;  }> {
