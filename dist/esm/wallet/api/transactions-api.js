...
export const TransactionsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        getUserTransactions: (cursor_1, limit_1, ...args_1) => __awaiter(this, [cursor_1, limit_1, ...args_1], void 0, function* (cursor, limit, options = {}) {
    ...
    return {
        ...
        getUserTransactions(cursor, limit, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerBasePath = (_c = (_b = operationServerMap['TransactionsApi.getUserTransactions']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
