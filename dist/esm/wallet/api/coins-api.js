...
export const CoinsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        getCoinDetails: (symbol_1, ...args_1) => __awaiter(this, [symbol_1, ...args_1], void 0, function* (symbol, options = {}) {
         ...
         * @throws {RequiredError}
         */
        getSupportedCoins: (...args_1) => __awaiter(this, [...args_1], void 0, function* (options = {}) {
    ...
    return {
        ...
        getCoinDetails(symbol, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerBasePath = (_c = (_b = operationServerMap['CoinsApi.getCoinDetails']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
        ...
        getSupportedCoins(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = operationServerMap['CoinsApi.getSupportedCoins']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
