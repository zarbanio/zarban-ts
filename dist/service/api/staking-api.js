...
const StakingApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        collectStakingReward: (stakingCollectRewardTxRequest_1, ...args_1) => tslib_1.__awaiter(this, [stakingCollectRewardTxRequest_1, ...args_1], void 0, function* (stakingCollectRewardTxRequest, options = {}) {
         ...
         * @throws {RequiredError}
         */
        getStakingPlans: (...args_1) => tslib_1.__awaiter(this, [...args_1], void 0, function* (options = {}) {
         ...
         * @throws {RequiredError}
         */
        getUserStakingStats: (user_1, address_1, active_1, cursor_1, limit_1, ...args_1) => tslib_1.__awaiter(this, [user_1, address_1, active_1, cursor_1, limit_1, ...args_1], void 0, function* (user, address, active, cursor, limit, options = {}) {
         ...
         * @throws {RequiredError}
         */
        stakeToStakingContract: (stakingStakeTxRequest_1, ...args_1) => tslib_1.__awaiter(this, [stakingStakeTxRequest_1, ...args_1], void 0, function* (stakingStakeTxRequest, options = {}) {
         ...
         * @throws {RequiredError}
         */
        withdrawStakedAsset: (stakingWithdrawTxRequest_1, ...args_1) => tslib_1.__awaiter(this, [stakingWithdrawTxRequest_1, ...args_1], void 0, function* (stakingWithdrawTxRequest, options = {}) {
